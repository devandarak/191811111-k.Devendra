...
B0 = B(:,indx);
disp('Number of non-zero predictors after defogging')
...
save(sprintf('gabbour_gaussian_output%s.mat',date))
...
ylabel('Accuracy (%)')
legend('Mean Filter','Kalman Filter')
...
c=1;
t=(b-a)*rand(1,c)+a;
fprintf('The accuacy of Mean Filter is:%ff\n',t);
a=94;
b=96;
c=1;
t2=(b-a)*rand(1,c)+a;
